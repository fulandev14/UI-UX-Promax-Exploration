    ...
    >
      <div className="mx-auto max-w-[116rem]">
        <div className="border-t border-[rgb(251_248_241_/_0.36)]">
          <div className="grid gap-10 py-10 md:grid-cols-2 lg:grid-cols-[1.08fr_1fr_1fr] lg:gap-0 lg:py-12">
            ...
            <div className="border-t border-[rgb(251_248_241_/_0.28)] pt-8 md:border-t-0 md:pt-0 lg:border-l lg:px-14">
              ...
              <dl className="mt-6 space-y-3 font-mono text-sm font-medium uppercase leading-none tracking-normal text-[rgb(251_248_241_/_0.94)] sm:text-base md:text-lg">
            ...
            <div className="border-t border-[rgb(251_248_241_/_0.28)] pt-8 md:col-span-2 md:border-t md:pt-8 lg:col-span-1 lg:border-l lg:border-t-0 lg:px-14 lg:pt-0">
              ...
              <address className="mt-6 space-y-3 font-mono text-sm font-medium uppercase not-italic leading-none tracking-normal text-[rgb(251_248_241_/_0.94)] sm:text-base md:text-lg">
                <a
        ...
        <p
          ...
          className="break-words font-sans text-[4rem] font-black uppercase leading-[0.76] tracking-normal text-[rgb(251_248_241_/_0.96)] sm:text-[6.4rem] md:text-[8.8rem] lg:whitespace-nowrap lg:text-[10.2rem] xl:text-[12.2rem] 2xl:text-[13.7rem]"
        >
          Atelier Elan
        </p>
      </div>
